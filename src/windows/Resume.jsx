...
const ResumeSkeleton = () => (
    <div className="w-full h-[800px] bg-white p-10 space-y-6 animate-pulse select-none overflow-hidden">
        {/* Header section skeleton */}
        <div className="flex items-center space-x-4 border-b border-gray-100 pb-6">
            <div className="size-16 bg-gray-200 rounded-full shrink-0"></div>
        ...
        <div className="space-y-3 pt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="h-16 bg-gray-100 rounded-lg p-3 space-y-2">
                    <div className="h-4 bg-gray-200 rounded w-1/2"></div>
...
const Resume = () => {
    return (
        <>
            ...
            <div className="w-[600px] h-[800px] max-h-[80vh] overflow-y-auto overflow-x-hidden bg-gray-100 flex justify-center">
